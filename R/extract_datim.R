...
#' @title Query targets data from DATIM
#'
#' @note Old function re-written as `datim_query()``
#'
#' @param ou        Operating Unit
#' @param org_lvl   Level
#' @param type      Technical
#' @param datim_cy  Fiscal year
#' @param username  Datim Username
#' @param password  Datim Password
#' @param baseurl   Datim API URL
#'
datim_query_old <- function(ou,
                            org_lvl = "facility",
                            type = "TX",
